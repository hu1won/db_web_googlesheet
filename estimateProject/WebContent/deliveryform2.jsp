...
<script>
    window.onload = function tablesubmit(){ 	
            	...
            	var quantity = 'clear'
            	var price = 'clear'
            	var totalprice = 'clear'
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbzmltn0XIp_ci5RDMPjULZEu1HTxN1s954qC-ICxsozcV2uqPMD/exec",
        			data: {구분:name,품명:product,규격:standard,단위:unit,수량:quantity,단가:price,금액:totalprice
        			      },
        			type: "POST",
            	...
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbwAmFP5oULQcK6EaHxMFA5CSu5qiOnQPE_6prMwD3FpZEwhoNQK/exec",
        			data: {구분:name,품명:product,규격:standard,단위:unit,수량:quantity,단가:price,금액:totalprice
        			      },
        			type: "POST",
        			success: function(data){
            	...
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbxWuze-NtNvoXDgd5CdlA8YwEzd5269T_Rsn6PsHa2KJrz4VtY/exec",
        			data: {구분:name,품명:product,규격:standard,단위:unit,수량:quantity,단가:price,금액:totalprice
        			      },
        			type: "POST",
        			success: function(data){
            	...
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbwDPm5UP4DXtVLS-fW7-EuIAgSIXJiEOm-qdnDmultq1_olKzTh/exec",
        			data: {구분:name,품명:product,규격:standard,단위:unit,수량:quantity,단가:price,금액:totalprice
        			      },
        			type: "POST",
        			success: function(data){
            	...
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbwQ0KMpHdfpxuE80OpaoGE9L9m1OppnCUZ7YG_S1Cmg7bvWdyQ/exec",
...
<div class="inputs">
<form action="deliverycontrol2.jsp" method"post">
  <br>
