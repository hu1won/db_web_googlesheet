...
<script>
    window.onload = function tablesubmit(){ 	
            	...
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbxTbBdRtNOSZfUKVRhgpkGMKGXTmig56U9a05MgzxkhlQkFCMU/exec",
            	...
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbxXbBg9Vt7qeJtPurM1UdxQD3SRUhqq6_O3d29ruUuIrBa9mfE/exec",
        			data: {구분:name,품명:product,규격:standard,단위:unit,수량:quantity,단가:price,금액:totalprice
        			      },
        			type: "POST",
        			success: function(data){
            	...
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbzvbhwejmhGwy231e9-LsT6VIrP_XBzYB1alfhdXpXEhCghLMwP/exec",
        			data: {구분:name,품명:product,규격:standard,단위:unit,수량:quantity,단가:price,금액:totalprice
        			      },
        			type: "POST",
        			success: function(data){
            	...
            	$.ajax({
        			url: "https://script.google.com/macros/s/AKfycbwunM9ACXXoS5yp1ckA-Mwu0O1oRZHKNszCQJmUPxdaxDxxMXiV/exec",
        			data: {구분:name,품명:product,규격:standard,단위:unit,수량:quantity,단가:price,금액:totalprice
        			      },
        			type: "POST",
        			success: function(data){
...
<div class="inputs">
<form action="deliverycontrol3.jsp" method"post">
  <br>
